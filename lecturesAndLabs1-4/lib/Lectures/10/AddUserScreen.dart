...
class _AddUserState extends State<AddUser> {
          ...
          children: [
            ...
            Align(
              ...
              child: ElevatedButton(
                onPressed: () {
                  addUser(email: emailController.text,gender: genderController.text,name: nameController.text);
                },
  ...
  void addUser({required String name,required String email,required String gender}) async {
